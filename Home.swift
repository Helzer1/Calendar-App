            ...
            func requestCalendarPermission() {
                eventStore.requestFullAccessToEvents() { granted, error in
                    if granted {
                        ...
                        // Handle the case where permission is not granted and there's an error
                        print("Calendar permission not granted. Error: \(error.localizedDescription)")
                    } else {
                        // Handle the case where permission is not granted without an error
